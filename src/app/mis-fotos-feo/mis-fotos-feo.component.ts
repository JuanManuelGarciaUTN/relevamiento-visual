...
@Component({
  selector: 'app-mis-fotos-feo',
  templateUrl: './mis-fotos-feo.component.html',
  styleUrls: ['./mis-fotos-feo.component.scss'],
})
export class MisFotosFeoComponent  implements OnInit {
